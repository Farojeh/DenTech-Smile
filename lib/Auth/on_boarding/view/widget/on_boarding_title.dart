            ...
            return Positioned(
              ...
              child: SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                     !statetr.isEn?state.pageArray[index]["artitle"]:state.pageArray[index]["title"],
                      style: TextStyle(
                    ...
                    Padding(
                      ...
                      child: Text(
                       !statetr.isEn?state.pageArray[index]["arsubtitle"] :state.pageArray[index]["subtitle"],
                        style: TextStyle(
