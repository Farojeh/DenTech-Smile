...
class ArticleStage extends StatefulWidget {
  const ArticleStage({super.key});

  @override
  State<ArticleStage> createState() => _ArticleStageState();
}

class _ArticleStageState extends State<ArticleStage> {
