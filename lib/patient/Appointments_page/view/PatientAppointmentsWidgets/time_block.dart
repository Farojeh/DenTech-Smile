  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        Static.showMyDialog(
            context,
            '${context.watch<ThemeCubit>().isArabic ? Lang.arabLang["message4"]! : Lang.enLang["message4"]!}\n'
            ' ${context.watch<ThemeCubit>().isArabic ? Lang.arabLang["hour"]! : Lang.enLang["hour"]!} ${times.time}  \n',
            times.id!);
      },
      child: Container(
