...
class DialogEvaluateDoctor extends StatelessWidget {
  const DialogEvaluateDoctor({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Dialog(
      ...
      child: Container(
        ...
        height: Static.getheight(context, 480),
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  SizedBox(
                    width: Static.getwidth(context, 75),
                  ...
                  Padding(
                    ...
                    child: Text(
                      '/',
                      style: TextStyle(
                        fontSize: Static.getwidth(context, 30),
