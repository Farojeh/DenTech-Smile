...
class BookStage extends StatefulWidget {
  const BookStage({super.key});

  @override
  State<BookStage> createState() => _VideoStageState();
}

class _VideoStageState extends State<BookStage> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            height: Static.getheight(context, 210),
            child: GridView.count(
              ...
              children: stage.map<Widget>((StageModel item) {
                ...
                return InkWell(
                  onTap: () {
                    setState(() {
                      selectedId = int.parse(item.id.toString());
                      context.read<PageCubit>().pdfStageId = item.id!;
                    });
                  },
                  child: Row(
                    children: [
