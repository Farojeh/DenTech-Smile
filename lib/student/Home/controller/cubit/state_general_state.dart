...
final class StateGeneralsuccess extends StateGeneralState {
  ...
  StateGeneralsuccess({required this.previousdescription, required this.appointmentid, required this.xrayimage, required this.patientid, required this.befor, required this.after});
}
