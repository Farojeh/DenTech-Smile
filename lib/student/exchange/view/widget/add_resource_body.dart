...
class _AddResourceBodyState extends State<AddResourceBody> {
  ...
  Widget build(BuildContext context) {
    return BlocListener<AddResourceCubit, AddResourceState>(
      listener: (context, state) {
        if(state is AddResourcefailure){
          Static.failure(context, state.errormessage);
        }else if (state is AddResourceSuccess){
          GoRouter.of(context).pushReplacement(AppRouter.myresourcespage);
        }
      },
        ...
        child: Column(
          ...
          children: [
            ...
            const ResourceTitle(
                ...
                image: "assets/images/signature 1.png"),
            Form(
                autovalidateMode: autovalidateMode,
                key: formkey,
                child: const CustomResourceField()),
            const ResourceTitle(
                name: "Resource’s Category",
                image: "assets/images/widget 1.png"),
            ...
            Padding(
              ...
              child: CustomButton(
                  ...
                  child: BlocBuilder<AddResourceCubit, AddResourceState>(
                    builder: (context, state) {
                      if (state is AddResourceLoading) {
