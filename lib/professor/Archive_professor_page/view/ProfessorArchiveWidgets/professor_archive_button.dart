...
import 'package:dentech_smile/professor/Case_doctor_page/view/dialog_evaluate_doctor.dart';
import 'package:flutter/material.dart';

class ProfessorArchiveButton extends StatelessWidget {
  const ProfessorArchiveButton({super.key});
